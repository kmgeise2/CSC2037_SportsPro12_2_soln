...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSC2037_SportsPro12_2_soln.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("CSC2037_SportsPro12_2_soln.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("CSC2037_SportsPro12_2_soln.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("CSC2037_SportsPro12_2_soln.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CSC2037_SportsPro12_2_soln.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CustomerProduct", b =>
                {
                    b.HasOne("CSC2037_SportsPro12_2_soln.Models.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomersCustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC2037_SportsPro12_2_soln.Models.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CSC2037_SportsPro12_2_soln.Models.Customer", b =>
                {
                    b.HasOne("CSC2037_SportsPro12_2_soln.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("CSC2037_SportsPro12_2_soln.Models.Incident", b =>
                {
                    b.HasOne("CSC2037_SportsPro12_2_soln.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC2037_SportsPro12_2_soln.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC2037_SportsPro12_2_soln.Models.Technician", "Technician")
                        .WithMany()
